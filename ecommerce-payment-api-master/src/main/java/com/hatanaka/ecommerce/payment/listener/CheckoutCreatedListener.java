...
public class CheckoutCreatedListener {
    ...
    private final CheckoutProccessor checkoutProccessor;

    @StreamListener(CheckoutProccessor.INPUT)
    public void handler(CheckoutCreatedEvent event){
        ...
        final PaymentCreatedEvent paymentCreatedEvent = PaymentCreatedEvent.newBuilder()
                ...
                .build();
        checkoutProccessor.output().send(MessageBuilder.withPayload(paymentCreatedEvent).build());
